...
def f_cube(p: jnp.ndarray, size: float = 1.0) -> float:
...
def f_dodecahedron(p: jnp.ndarray, scale: float = 0.7, r: float = 1.0) -> float:
...
def surface_a(xyz: jnp.ndarray) -> float:
    """
    Evaluate the surface defined by
    ((x − 1)·x²·(x + 1) + y²)² +
    ((y − 1)·y²·(y + 1) + z²)² +
    0.1·y² +
    0.05·(y − 1)·y²·(y + 1) = 0
    """
    x, y, z = xyz
    term1 = ((x - 1) * x**2 * (x + 1) + y**2)**2
    term2 = ((y - 1) * y**2 * (y + 1) + z**2)**2
    term3 = 0.1 * y**2
    term4 = 0.05 * (y - 1) * y**2 * (y + 1)
    return term1 + term2 + term3 + term4

def surface_b(xyz: jnp.ndarray) -> float:
    """
    Evaluate the surface defined by
    15·((x − 1.2)·x²·(x + 1.2) + y²)² +
    0.8·(z − 1)·z²·(z + 1) − 0.1·z² +
    20·((y − 0.8)·y²·(y + 0.8) + z²)² +
    0.8·(x − 1)·z²·(x + 1) − 0.1·x² = 0
    """
    x, y, z = xyz
    term1 = 15.0 * ((x - 1.2) * x**2 * (x + 1.2) + y**2)**2
    term2 = 0.8 * (z - 1.0) * z**2 * (z + 1.0) - 0.1 * z**2
    term3 = 20.0 * ((y - 0.8) * y**2 * (y + 0.8) + z**2)**2
    term4 = 0.8 * (x - 1.0) * z**2 * (x + 1.0) - 0.1 * x**2
    return term1 + term2 + term3 + term4

def surface_c(xyz: jnp.ndarray) -> float:
    """
    Evaluate the surface defined by
    (3·(x − 1)·x²·(x + 1) + 2·y²)² +
    (z² − 0.85)²·(3·(y − 1)·y²·(y + 1) + 2·z²)² +
    (x² − 0.85)²·(3·(z − 1)·z²·(z + 1) + 2·x²)² +
    (y² − 0.85)²·(−0.12) = 0
    """
    x, y, z = xyz
    term1 = (3.0 * (x - 1.0) * x**2 * (x + 1.0) + 2.0 * y**2)**2
    term2 = (z**2 - 0.85)**2 * (3.0 * (y - 1.0) * y**2 * (y + 1.0) + 2.0 * z**2)**2
    term3 = (x**2 - 0.85)**2 * (3.0 * (z - 1.0) * z**2 * (z + 1.0) + 2.0 * x**2)**2
    term4 = (y**2 - 0.85)**2 * (-0.12)
    return term1 + term2 + term3 + term4